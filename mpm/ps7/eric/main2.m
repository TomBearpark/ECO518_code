...
box on
grid on
legend({['Semi-parametric ($\widehat{\beta}$=' num2str(beta0, 3) ...
    ', SE=' num2str(std(ResBoot.semipara),3) ')'],...
    ['Series (p=2) ($\widehat{\beta}$=' num2str(lm1.Coefficients{'X', 'Estimate'}, 3) ...
    ', SE=', num2str(std(ResBoot.linear), 3) ')' ]}, 'Interpreter', 'latex',...
